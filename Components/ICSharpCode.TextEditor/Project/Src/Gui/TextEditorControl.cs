...
namespace ICSharpCode.TextEditor
{
	...
	public class TextEditorControl : TextEditorControlBase
	{
        ...
        protected override void OnDocumentReplaced()
        {
            if (primaryTextArea != null)
                primaryTextArea.AttachToDocumentEvents();
            base.OnDocumentReplaced();
        }

        protected override void OnBeforeDocumentReplaced()
        {
            if (primaryTextArea != null)
                primaryTextArea.DetachDocumentEvents();

            base.OnBeforeDocumentReplaced();
        }
		...
		protected override void CommitUpdateRequested(object sender, EventArgs e)
		{
			if (!handleupdates || IsInUpdate) {
				return;
			}
