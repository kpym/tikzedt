...
namespace TikzEdt.ViewModels
{
    ...
    public class TEDocumentVM : ViewModelBase
    {
        ...
        void TheCompiler_JobSucceeded(object sender, TexCompiler.JobEventArgs e)
        {
 ...
 /*       private bool _useBB;
        ...
        public TEDocumentVM(MainWindowVM parent, TexCompiler compiler, string cFile = null)
        {
            ...
            TheCompiler.Instance.JobSucceeded += TheCompiler_JobSucceeded;
            TheCompiler.Instance.OnTexError += addProblemMarker;
