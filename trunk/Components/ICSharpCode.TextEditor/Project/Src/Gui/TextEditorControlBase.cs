...
namespace ICSharpCode.TextEditor
{
	...
	public abstract class TextEditorControlBase : UserControl
	{
        ...
        protected virtual void OnDocumentReplaced()
        {

        }
        /// <summary>
        /// Only called if document is not null.
        /// </summary>
        protected virtual void OnBeforeDocumentReplaced()
        {

        }

        protected virtual void CommitUpdateRequested(object sender, EventArgs e)
        {
