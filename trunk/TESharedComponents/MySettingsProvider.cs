...
namespace TikzEdt
{
    ...
    public class TESettingsProvider : SettingsProvider
    {

        const string SETTINGSROOT = "Settings";
        //XML Root Node

        public TESettingsProvider(string settingsFileName)
        {
        ...
        public override string ApplicationName
        {
            get
            {
                ...
                if (A == null) 
                    return null;
                AssemblyProductAttribute assemblyProductAttribute = ((AssemblyProductAttribute[])A.GetCustomAttributes(typeof(AssemblyProductAttribute),false)).Single();

                if (assemblyProductAttribute != null && assemblyProductAttribute.Product.Trim().Length > 0)
                {
        ...
        private XmlDocument SettingsXML
        {
            get
            {
                ...
                if (_settingsXML == null)
                {
                    ...
                    try
                    {
                        _settingsXML.Load(_settingsFileName);
                    }
                    catch (Exception)
                    {
                        //Create new document
