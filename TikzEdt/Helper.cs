...
";
  ...
  /*  static class Helper
    ...
    class PropertiesCompilerSettings : CompilerSettings
    {
        ...
        public override string Tex_Preamble
        {
            get
            {
                return Properties.Settings.Default.Tex_Preamble;
            }
        }

        public override string Tex_Postamble
        {
            get
            {
                return Properties.Settings.Default.Tex_Postamble;
            }
        }
